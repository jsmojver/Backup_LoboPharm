...
DATABASES = {
    ...
    'eskulap': {
        ...
        'NAME': '192.168.1.229/ORCL',                      # Or path to database file if using sqlite3.
        'USER': 'IDEMA',                      # Not used with sqlite3.
        'PASSWORD': 'IDEMA-ESKULAP',                  # Not used with sqlite3.
        'HOST': '192.168.1.229',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
    }
}

DATABASE_ROUTERS = [ 'project.eskulap.router.Router' ]
